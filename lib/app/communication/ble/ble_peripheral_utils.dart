...
class BlePeripheralUtils {
  ...
  ReadRequestResult? onReadRequest(
    ...
    ReadRequestResult? result = switch (characteristicId.toUpperCase()) {
      ...
      // Protocol Mode: 0x01 = Report Protocol Mode (required for Android BLE HID)
      characteristicProtocolMode => _toReadRequest([0x01]),
  ...
  late final BleService hidService = BleService(
    ...
    characteristics: [
      ...
      // Combined Input Report characteristic.
      // Report Reference descriptor is NOT included so Android BLE HID Host
      // accepts embedded Report IDs in the data (as defined in the Report Map).
      BleCharacteristic(

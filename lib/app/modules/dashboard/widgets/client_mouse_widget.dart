          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(AppStrings.get('clientScreenTitle')),
                ...
                Column(
                  children: [
                    ...
                    const SizedBox(height: 10),
                    Text(
                      AppStrings.clientMovements(mouseMovement.$1, mouseMovement.$2),
                    ),
                  ],
                ),
                Padding(
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            ...
                            validator: (value) {
                              ...
                              return AppStrings.get('widthRequired');
                              }
                              return null;
                            },
                            decoration: InputDecoration(
                              labelText: AppStrings.get('width'),
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                              return AppStrings.get('heightRequired');
                              }
                              return null;
                            },
                            decoration: InputDecoration(
                              labelText: AppStrings.get('height'),
                              border: const OutlineInputBorder(),
                            ),
                          ),
                        )
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(AppStrings.get('updateClientSize')),
                  ),
                ),
                const SizedBox(height: 10),
                Padding(
                  ...
                  child: Card(
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
                        AppStrings.get('clientSizeExplanation'),

    ...
    return Card(
      child: Theme(
        ...
        child: Form(
          key: _formKey,
          child: ExpansionTile(
            title: Text(AppStrings.get('synergyTitle')),
            subtitle: Text(
              AppStrings.get('synergySubtitle'),
            ...
            children: [
              Padding(
                ...
                child: _KTextFiled(
                  hintText: AppStrings.get('clientNameHint'),
                ...
                child: Row(
                  children: [
                    Expanded(
                      flex: 3,
                      child: _KTextFiled(
                        hintText: AppStrings.get('serverAddressHint'),
      ...
      child: TextFormField(
        ...
        validator: (value) {
          if (value == null || value.isEmpty) {
            return AppStrings.get('pleaseEnterValue');
          }
          return null;
        },

    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog.adaptive(
          title: Text(AppStrings.get('quitTitle')),
          actions: [
            TextButton(
...
class _NoClientWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      child: ListTile(
          title: Text(
          AppStrings.get('noClientYet'),
          style: const TextStyle(color: Colors.grey),
        ),
        subtitle: Text(
          AppStrings.get('noClientSubtitle'),

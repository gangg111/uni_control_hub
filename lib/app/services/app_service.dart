...
class AppService {
  ...
  late final locale = Signal<String>(StorageService.to.languageCode);
  ...
  void _loadInitialValues() {
    AppStrings.setLocale(storageService.languageCode);
    ...
    effect(() {
      storageService.languageCode = locale.value;
    });
